  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[11px] leading-none text-left tracking-wide relative left-[10px]">
        <span className="transition-colors text-[15px] uppercase  text-[#666666]/80 font-medium ">
          INCHES
        </span>
        <span className="transition-colors text-[15px] uppercase text-[#666666]/80 font-medium">
          MILLIMETRES
